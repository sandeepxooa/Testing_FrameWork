...
public class Buy_Token_From_MarketPlace 
{
	...
	@FindBy(xpath="(//div[@id='root']//span[text()='General Market']/parent::a)[1]")
	...
	public void Buy_Token_of_single_Edition() throws InterruptedException
	{
		...
		String BuyOption="//div[@id='root']//div[@class='row']//div[@class='MuiCardContent-root px-2 pt-3 pb-1']//p/span[text()='"+MintedTokenName+"']//ancestor::div/following-sibling::button/div/button[text()='Buy']";
		//div[@id='root']//div[@class='row']//div[@class='MuiCardContent-root px-2 pt-3 pb-1']//p/span[text()='Test_Token_Tue Jun 29 12:42:58 GMT 2021']//ancestor::div/following-sibling::button/div/button[text()='Buy']		
	...
	public void StripModal() throws InterruptedException 
	{
	...
	public void Buy_Token_of_Multiple_Edition() throws InterruptedException
	{
		...
		String BuyOption="//div[@id='root']//div[@class='row']//div[@class='MuiCardContent-root px-2 pt-3 pb-1']//p/span[text()='"+MintedTokenName+"']//ancestor::div/following-sibling::button/div/button[text()='Buy Edition']";
		//div[@id='root']//div[@class='row']//div[@class='MuiCardContent-root px-2 pt-3 pb-1']//p/span[text()='Test_Token_Thu Jun 10 14:45:14 GMT 2021']//ancestor::div/following-sibling::button/div/button[text()='Buy Edition']
...
//		wait7.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='modal-content'])[2]//input[@id='name']")));
//
//
...
//		Authorize_Charge_Button.click();
	...
	public void ErrorMassage_on_StripePayment_modal()
	{
		WebElement msddiv=driver.findElement(By.xpath("//div[@role='alert']"));
		System.out.println(msddiv.isDisplayed());
		System.out.println("ErrorMassage_on_StripePayment_moda for buy through same account"+msddiv.getText());
	}

	public void Close_to_StripePayment_modal() throws InterruptedException
	{
		Actions act3 =  new Actions(driver);
		act3.moveToElement(driver.findElement(By.xpath("//i[@class='fa fa-close']"))).click().perform();;
//		WebElement StripePayment_modal_CloseButton=driver.findElement(By.xpath("//i[@class='fa fa-close']"));
//		StripePayment_modal_CloseButton.click();
		Thread.sleep(1000);
		

	}
	
	public void Close_to_Buy_modal() throws InterruptedException
	{
		WebElement Buy_modal_CloseButton=driver.findElement(By.xpath("//button[@class='close']"));

		Buy_modal_CloseButton.click();
		Thread.sleep(1000);
